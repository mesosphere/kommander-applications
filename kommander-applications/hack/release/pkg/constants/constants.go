...
const (
	...
	// NKPCLIVersion (hardcoded version for artifact generation).
	NKPCLIVersion        = "v0.0.0-dev.0"
	DefaultSourceNKPBase = "https://s3.amazonaws.com/downloads.mesosphere.io/dkp/v0.0.0-dev.0"
